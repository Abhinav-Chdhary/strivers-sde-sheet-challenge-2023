...
int main()
{
    ...
    int editDistRecursive = editDistance(str1, str2);
    cout << "Edit distance using recursive approach: " << editDistRecursive << endl;

    // Using tabulation approach
    int editDistTabulation = minDistance(str1, str2);
    cout << "Edit distance using tabulation approach: " << editDistTabulation << endl;
